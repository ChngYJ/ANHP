...
class CausalNET(object):
    ...
    def train(self, dataset, data, topology, true_cm=None):
        ...
        for epoch_i in range(self.epochs):
            data_dir = proj_dir + '/models/' + self.args.dataset.input_format + '/' + dataset + '/' + 'epoch_data' + '/'
...
def preprocess_data(data, topology, opt):
    ...
    data_dir = proj_dir + '/models/' + opt.model.dataset.input_format + '/' + opt.dataset + '/' + 'epoch_data' + '/'
